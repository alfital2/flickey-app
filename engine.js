...
(function(){
  ...
  // a believable little content grid below the search (image tile + two text lines)
  var bcards=mk('div','bcards');
  for(var _i=0;_i<3;_i++){
    var bc=mk('div','bcard');
    var bt=mk('div','bthumb'); var bl1=mk('div','bline'); var bl2=mk('div','bline sm');
    bc.appendChild(bt); bc.appendChild(bl1); bc.appendChild(bl2); bcards.appendChild(bc);
  }
  bpage.appendChild(bcards);
  ...
  function selectStop(si){
    ...
    if(app.browser){
      ...
      bpage.style.setProperty('--bsite', tab.fav);   // tint the content tiles to the site brand
